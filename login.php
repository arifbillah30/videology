            ...
            <div class="sign-user_card ">                    
               <div class="sign-in-page-data">
                  <div class="sign-in-from w-100 m-auto">
                     ...
                     <form class="mt-4" action="includes/check_log.php" method="POST">
                        <div class="form-group">                                 
                           <input type="email" class="form-control mb-0" name="email" id="exampleInputEmail1" placeholder="Enter email" autocomplete="off" required>
                        </div>
                        <div class="form-group">                                 
                           ...
                           <div class="sign-info">
                              <button type="submit" name="singup" class="btn btn-hover">Sign in</button>
