...
<body>
    ...
    <!-- breadcrumb -->
    <div class="gen-breadcrumb" style="background-image: url('');">
        <div class="container">
                        ...
                        <div class="gen-breadcrumb-container">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php"><i
                                            class="ri-sm ri-home-line mr-1 "></i>Home</a></li>
                                            <li> | </li>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="gen-icon-box-style-1">
                        ...
                        <div class="gen-icon-box-content">
                            ...
                            <p class="gen-icon-box-description"> ECB Chattar, Dhaka Cantonment, Dhaka - 1206, Bangladesh</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mt-4 mt-md-0">
                    <div class="gen-icon-box-style-1">
                        <div class="gen-icon-box-icon">
                            <span class="gen-icon-animation">
                                <i class="ri-contacts-line"></i></span>
                        </div>
                        <div class="gen-icon-box-content">
                            <h3 class="pt-icon-box-title mb-2">
                                <span>call us at</span>
                            </h3>
                            <p class="gen-icon-box-description">+880 1793636121<br>+880 969236121</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-12 mt-4 mt-xl-0">
                    <div class="gen-icon-box-style-1">
                        ...
                        <div class="gen-icon-box-content">
                            ...
                            <p class="gen-icon-box-description">info@videology.com<br>info2@videology.com</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div style="width: 100%"><iframe width="100%" height="550" frameborder="0" scrolling="no"
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14599.5554152899!2d90.3846743272295!3d23.82255105285987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c6c2ab936b87%3A0xcaa915c4069493be!2sECB%20Chattar%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1671654520414!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="block-space">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4">
                     <ul class="f-link list-unstyled mb-0">
                        <li><a href="#">FAQ</a></li>
                        <li><a href="contact-us.php">Cotact Us</a></li>
